...
export function VerseCard({
  ...
  return (
    ...
    >
      ...
      {/* Translation — `text-sm` is the fallback; an inline fontSize (from the
          reader's "Translation size" control) overrides it when present. */}
      {showTranslation && line.translation && (
        <p className="text-sm text-[#C9C0A8] mb-2" style={{ fontFamily: "'Noto Sans Tamil', 'Noto Sans', sans-serif", fontSize: translationFontSize }}>{line.translation}</p>
      )}
        ...
        {tafsirExpanded && (
          ...
          >
            {tafsirIsLoading ? (
              ...
              <TafsirContent html={tafsirText} fontSize={tafsirFontSize} />
            ) : (
