...
interface Props {
  ...
  /** Reader typography controls for the translation + tafsir text (px). */
...
export function QuranReaderContent(props: Props) {
  const {
    ...
    showRoots, tajweedEnabled, arabicFontSize, arabicLineHeight, translationFontSize, tafsirFontSize, arabicFontFamily, scriptStyle, surahs, translationId, tafsirId, playingKey, bookmarkedKeys,
