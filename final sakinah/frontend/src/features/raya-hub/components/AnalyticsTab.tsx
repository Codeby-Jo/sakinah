...
import { Card, EmptyState, GOLD, RevealOnScroll, SectionTitle, SkeletonRows } from './ui';
...
function ChartCard({ title, children }: { title: string; children: React.ReactNode }) {
  // Wrapped so every chart reveals on scroll (direction-aware) automatically.
  return (
    <RevealOnScroll>
...
export function AnalyticsTab() {
  ...
  return (
    <div>
      ...
      <RevealOnScroll className="grid grid-cols-2 sm:grid-cols-4 gap-3 mb-6">
