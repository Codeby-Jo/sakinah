...
export const DISCLAIMERS: Record<string, DisclaimerContent> = {
  ...
  AI_CHATBOT: {
    ...
    body: 'Our AI companions (Raya, Sahaba, Sahabiyat, and Imam personas) draw on authentic Islamic sources but are not qualified scholars, muftis, or counsellors. Their responses may contain inaccuracies. For religious rulings (fatawa), always consult a qualified scholar from your trusted school of thought. For mental health concerns, please reach out to a licensed professional. The AI does not replace human wisdom — it is a tool to support your journey.',
