...
from nis.engines.preference_engine import evaluate_preferences
...
pref = evaluate_preferences(nis_aisha, nis_pref_tariq)

print("HF MISMATCHES:", hf.get("soft_mismatches"))
print("PREF MISMATCHES:", pref.get("soft_mismatches"))
