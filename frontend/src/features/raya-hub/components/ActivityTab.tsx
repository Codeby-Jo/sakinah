...
import { Card, Collapsible, EmptyState, GOLD, RevealOnScroll, SectionTitle, SkeletonRows } from './ui';
...
export function ActivityTab() {
  return (
    <div>
      {/* Each section reveals on scroll (direction-aware) via the shared wrapper. */}
      <RevealOnScroll><ActionsSection /></RevealOnScroll>
      <RevealOnScroll><RemindersSection /></RevealOnScroll>
      <RevealOnScroll><ChatsSection /></RevealOnScroll>
      <RevealOnScroll><MemoriesSection /></RevealOnScroll>
    </div>
  );
}
