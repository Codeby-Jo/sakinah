...
import {
  ArrowSquareOut, BellRinging, BookOpen, Brain, CalendarBlank, ChartBar,
...
import { Card, GOLD, RevealOnScroll, SectionTitle, SkeletonRows } from '../components/ui';
...
function OverviewTab({
  ...
  return (
    <>
      ...
      {/* Each capability box reveals individually (so they cascade as you scroll),
          rather than the whole grid animating as one block. */}
