                    ...
                    <div className="min-w-0 flex-1">
                      ...
                      {showTranslation && line.translation && (
                        <p
                          ...
                          style={{ fontFamily: "'Noto Sans Tamil', 'Noto Sans', sans-serif", fontSize: translationFontSize }}
                        >
                          {line.translation}
                        </p>
                      )}
                        ...
                        {expanded && (
                          ...
                          >
                            {loadingT ? (
                              ...
                              <TafsirContent html={tafsirCache[line.verseKey]} fontSize={tafsirFontSize} />
                            ) : (
