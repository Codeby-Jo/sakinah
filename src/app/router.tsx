...
export const router = createBrowserRouter([
  ...
  // so every /matrimony/* page can call useOnboarding() without crashing.
  {
    ...
    children: [
      ...
      { path: 'verify-otp', element: <LazyPage Component={SakinahVerifyOtpPage} /> },
      ...
      { path: 'wali/login', element: <LazyPage Component={SakinahWaliLoginPage} /> },
      { path: 'wali/register', element: <LazyPage Component={SakinahWaliRegisterPage} /> },
      { path: 'wali/verify', element: <LazyPage Component={SakinahWaliVerifyPage} /> },
      { path: 'wali/candidate-profile', element: <LazyPage Component={SakinahWaliCandidateProfilePage} /> },
      { path: 'wali/dashboard', element: <LazyPage Component={SakinahWaliDashboardPage} /> },
    ],
  },
