...
const sections = [
  ...
  },
  {
    ...
    items: [
      ...
      'To improve our AI features and platform through aggregated, anonymised analytics',
  ...
  },
  {
    ...
    items: [
      ...
      'AI conversations may be processed by trusted third-party AI providers under strict data processing agreements',
