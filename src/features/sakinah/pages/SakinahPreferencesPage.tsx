...
const prefSchema = z.object({
  ...
  educationPref: z.array(z.string()).optional(),
  religiousPracticePref: z.string().optional(),
  familyInvolvement: z.string().optional(),
  dealbreakers: z.array(z.string()).optional(),
  communicationStyle: z.string().optional(),
  repairStyle: z.string().optional(),
  boundarySafety: z.string().optional(),
  lifestyleFinances: z.string().optional(),
});
...
export const SakinahPreferencesPage: React.FC = () => {
  ...
  const { handleSubmit, watch, setValue, formState: { errors, isValid } } = useForm({
  ...
  const onSubmit = async (data: any) => {
    ...
    try {
      ...
      setProgress({ preferences_completed: true });
            ...
            <form onSubmit={handleSubmit(onSubmit)} className={`flex flex-col gap-10`}>
              ...
              <div className="mt-8 pt-8 border-t border-[rgba(212,175,55,0.1)] flex flex-col gap-2">
                ...
                <SakinahButton
                  ...
                  type="submit"
                  disabled={loading}
                  className="w-full py-4 transition-all font-semibold rounded-2xl text-[16px] bg-gradient-to-r from-[#D4AF37] to-[#F5D77A] text-[#050816] shadow-[0_0_20px_rgba(212,175,55,0.3)] hover:shadow-[0_0_40px_rgba(212,175,55,0.5)]"
                >
