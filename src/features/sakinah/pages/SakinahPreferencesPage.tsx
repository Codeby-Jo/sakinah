    ...
    <div className="sk-viewport">
      <div className="min-h-screen flex items-start justify-center px-6 py-12">
        <div className="w-full max-w-[560px]">
          <SakinahHeader title="Partner Preferences" subtitle="Step 5 of 6 · What Matters to You" onBack={() => navigate('/matrimony/profile-creation')} />
          ...
          <div className="flex gap-3 sk-fx sk-d2">
            <SakinahButton variant="ghost" onClick={() => navigate('/matrimony/profile-creation')} className="flex-1">Back</SakinahButton>
            <SakinahButton variant="primary" onClick={() => navigate('/matrimony/review')} className="flex-1">Review Profile →</SakinahButton>
          </div>
        </div>
      </div>
    </div>
