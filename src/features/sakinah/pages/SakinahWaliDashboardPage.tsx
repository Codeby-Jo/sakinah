        ...
        <motion.div variants={containerVariants} initial="hidden" animate="show" className="space-y-6">
          ...
          <motion.div variants={itemVariants}>
            <div className="flex items-center justify-between mb-4">
              ...
              <button onClick={() => navigate('/matrimony/matches')} className="text-[12px] text-[var(--sk-gold)] hover:text-[var(--sk-gold-soft)] transition-colors">View All →</button>
            </div>
                  ...
                  <div className="p-5 flex items-start gap-4">
                    ...
                    <div className="flex-1">
                      ...
                      <div className="mt-4 flex gap-2">
                        <button className="px-4 py-2 text-[12px] bg-[rgba(255,255,255,0.02)] text-[var(--sk-ink-dim)] border border-[rgba(255,255,255,0.05)] rounded-full hover:text-[var(--sk-ink)] transition-colors" onClick={() => navigate('/matrimony/matches')}>
                          View Details
                        </button>
                      </div>
                    </div>
          ...
          <motion.div variants={itemVariants} className="grid grid-cols-2 gap-4 pt-4 border-t border-[rgba(255,255,255,0.05)]">
            ...
            <div className="sk-card p-4 cursor-pointer hover:border-[var(--sk-gold)] hover:bg-[rgba(212,168,83,0.02)] transition-all group" onClick={() => navigate('/matrimony/chat')}>
