...
export const SakinahWaliRegisterPage: React.FC = () => {
  ...
  const handleContinue = () => {
    if (validate()) navigate('/wali/verify');
  };
    ...
    <div className="sk-viewport">
      <div className="min-h-screen flex items-center justify-center px-6 py-12">
        <div className="w-full max-w-[480px]">
          <SakinahHeader title="Wali Registration" subtitle="Step 1 · Your Details" onBack={() => navigate('/role')} />
          ...
          <div className="flex gap-3 mt-6 sk-fx sk-d3">
            <SakinahButton variant="ghost" onClick={() => navigate('/role')} className="flex-1">Back</SakinahButton>
