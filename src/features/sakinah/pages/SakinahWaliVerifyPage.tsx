  ...
  return (
    <div className="sk-viewport">
      <div className="min-h-screen flex items-center justify-center px-6 py-12 bg-gradient-to-b from-[#0A0E16] to-[#0d121c]">
        ...
        >
          <SakinahHeader title="Verify Wali" subtitle="Step 2 · OTP & Identity" onBack={() => navigate('/matrimony/wali/register')} />
          ...
          <div className="flex gap-3">
            <SakinahButton variant="ghost" onClick={() => navigate('/matrimony/wali/register')} className="flex-1">Back</SakinahButton>
            <SakinahButton variant="primary" onClick={() => navigate('/matrimony/wali/candidate-profile')} disabled={!allDone} className="flex-1 shadow-[0_0_20px_rgba(212,168,83,0.3)] hover:shadow-[0_0_30px_rgba(212,168,83,0.5)]">
              Continue →
            </SakinahButton>
          </div>
        </motion.div>
