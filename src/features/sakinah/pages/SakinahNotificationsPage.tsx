    ...
    const fetchNotifs = async () => {
      try {
        ...
        let mock: NotificationItem[] = [
          {
            id: 'n1', type: 'PROFILE_SHARED',
            title: 'Profile Shared',
            message: 'Your profile was shared by a Wali. A secure watermark has been applied to all your images.',
            timestamp: 'Just now', read: false
          },
          {
            id: 'n2', type: 'NEW_MATCH',
            title: 'New Highly Compatible Match',
            message: 'You have a new match with an 85% compatibility score. Review their profile now.',
            timestamp: '2 hours ago', read: false,
            actionUrl: '/matrimony/matches'
          },
          {
            id: 'n3', type: 'PROFILE_VIEW',
            title: 'Profile View Analytics',
            message: 'Your profile was viewed 14 times this week. 3 users passed your strict KYC requirements.',
            timestamp: 'Yesterday', read: true,
            actionUrl: '/matrimony/dashboard'
          },
          {
            id: 'n4', type: 'PHOTO_REQUEST',
            title: 'Photo Access Request',
            message: 'Ahmed has requested to view your private photos. All views will be logged securely.',
            timestamp: '2 days ago', read: true
          },
          {
            id: 'n5', type: 'FAMILY_ADDED',
            title: 'Wali Participation',
            message: 'Abdullah (Father) has successfully joined your private conversation as a Wali.',
            timestamp: 'Last week', read: true
          }
        ];
