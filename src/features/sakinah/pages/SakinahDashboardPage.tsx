      ...
      <div className="px-6 py-8 max-w-[1000px] mx-auto pb-24">
        ...
        <motion.div variants={containerVariants} initial="hidden" animate="show" className="space-y-6">
          ...
          <motion.div variants={itemVariants} className="grid grid-cols-2 gap-4 pt-4 border-t border-[rgba(255,255,255,0.05)]">
            <div className="sk-card p-4 cursor-pointer hover:border-[var(--sk-gold)] hover:bg-[rgba(212,168,83,0.02)] transition-all group" onClick={() => navigate('/matrimony/profile-creation')}>
            ...
            <div className="sk-card p-4 cursor-pointer hover:border-[var(--sk-gold)] hover:bg-[rgba(212,168,83,0.02)] transition-all group" onClick={() => navigate('/matrimony/preferences')}>
