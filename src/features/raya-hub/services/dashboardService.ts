...
export async function getDeepestConversation(): Promise<DeepestConversationResponse> {
  return authGet<DeepestConversationResponse>('/raya/dashboard/deepest');
}
