...
// The scroll-reveal building block now lives in the shared folder so every
// feature can use it. Re-export here so the raya-hub tabs can keep importing
// { RevealOnScroll, useScrollDirection } from './ui' unchanged.
export { RevealOnScroll, useScrollDirection } from '@/components/shared/RevealOnScroll';
