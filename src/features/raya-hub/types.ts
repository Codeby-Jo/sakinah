...
/** Deepest conversation + a standout Raya quote, decrypted server-side. */
export interface DeepestConversation {
  convoId: string;
  title: string;
  quote: string;
  messageCount: number;
...
export interface DeepestConversationResponse {
  /** Null when no conversation is deep enough to surface. */
  moment: DeepestConversation | null;
}
