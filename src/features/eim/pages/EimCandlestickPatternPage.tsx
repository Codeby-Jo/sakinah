    ...
    <div className="min-h-[calc(100dvh-60px)] bg-[#0C0F15]/70 backdrop-blur-md pb-[calc(9rem+env(safe-area-inset-bottom,0px))] lg:pb-32">
      <div className="max-w-2xl mx-auto">
        ...
        {/* Bottom nav — Prev / Next.
            ...
            shown below lg and hidden at lg+. Below lg we must sit ABOVE that tab
            bar (offset by its 4rem height) so Prev/Next stay tappable; at lg+ the
            tab bar is gone, so we sit flush at bottom-0. */}
        <nav className="fixed left-0 right-0 z-20 bg-[#0C0F15]/95 backdrop-blur-sm border-t border-[rgba(212,168,83,0.10)] bottom-16 lg:bottom-0">
