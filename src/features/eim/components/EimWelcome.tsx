 ...
 * → Screen), the promise (halal investing, no real money), and the calm,
...
const PILLARS = [
  ...
  },
  {
    icon: Scales,
    title: 'Screen',
    body: 'Screen any company against the halal standards — and see where the scholars agree and differ.',
  },
];
...
export function EimWelcome() {
  ...
  // Portal to <body> so the overlay escapes EimShell's <main> (z-5) stacking
  // context — otherwise the z-30 top bar / bottom nav paint OVER the card and
  // clip its CTA. Portaling lets z-[70] genuinely sit above all the chrome.
  return createPortal(
