...
export function FeatureIntro({
  ...
  return (
    <>
      ...
      {/* Portal to <body> so the overlay escapes EimShell's <main> (z-5)
          stacking context — otherwise the z-30 top bar / bottom nav paint OVER
          the card and clip its "Got it" CTA. */}
      {open && createPortal(
