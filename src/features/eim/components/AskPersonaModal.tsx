...
export function AskPersonaModal({
  ...
  // context — otherwise the z-30 chrome paints over the modal's edges/CTAs.
  return createPortal(
    <div
      role="presentation"
      ...
      >
        ...
        {answer && (
          <div>
            ...
            <div className="text-[13px] text-[#F5E8C7] leading-relaxed rounded-lg bg-[#0A0E16] border border-[rgba(212,168,83,0.10)] p-3">
