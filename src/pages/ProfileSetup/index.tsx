...
export default function ProfileSetup() {
  ...
  const goNext = () => {
    ...
    if (nextIdx < SECTIONS.length) { setActiveSection(SECTIONS[nextIdx]); window.scrollTo({ top: 0, behavior: 'smooth' }); }
    else { setProfile({ completed: true, data: form }); setShowSuccess(true); setTimeout(() => navigate('/kyc'), 1500); }
  };
