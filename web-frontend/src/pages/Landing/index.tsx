    ...
    <div className="flex flex-col bg-white">
      ...
      <section className="bg-white py-16 lg:py-24 border-b border-gray-100">
        <div className="max-w-7xl mx-auto px-6 grid lg:grid-cols-2 gap-12 items-center">
          <div>
            <span className="inline-block bg-red-50 text-[#7B1C2E] text-xs font-semibold px-3 py-1.5 rounded-full mb-5 uppercase tracking-wide">
              Trusted Islamic Matrimonial Platform
            </span>
            <h1 className="text-4xl md:text-5xl font-extrabold text-gray-900 leading-tight mb-5">
              Find Your Righteous Match<br />
              <span className="text-[#7B1C2E]">The Right Way</span>
            </h1>
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <Link to="/choose-role"
                className="text-center bg-[#7B1C2E] text-white px-8 py-3.5 rounded-lg font-semibold hover:bg-[#5e1522] transition-colors shadow-sm text-sm"
              >
                Register Free
              </Link>
              <Link to="/how-it-works"
                className="text-center border border-gray-300 text-gray-700 px-8 py-3.5 rounded-lg font-semibold hover:border-[#7B1C2E] hover:text-[#7B1C2E] transition-colors text-sm"
              >
                How It Works
              </Link>
            </div>
            ...
            <div className="flex gap-8 mt-10 pt-8 border-t border-gray-100">
              {[
                ...
                <div key={s.l}>
                  <p className="text-2xl font-extrabold text-[#7B1C2E]">{s.n}</p>
          ...
          <div className="bg-gray-50 border border-gray-200 rounded-2xl p-8">
            ...
            <Link to="/choose-role"
              className="mt-8 block text-center bg-[#7B1C2E] text-white py-3 rounded-lg font-semibold text-sm hover:bg-[#5e1522] transition-colors"
            >
        ...
        <div className="max-w-6xl mx-auto px-6">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {[
              ...
              <div key={s.n} className="bg-white border border-gray-200 rounded-xl p-6 hover:border-[#7B1C2E]/40 hover:shadow-sm transition-all">
                <p className="text-3xl font-extrabold text-[#7B1C2E]/20 mb-3">{s.n}</p>
        ...
        <div className="max-w-4xl mx-auto px-6 text-center">
          ...
          <div className="bg-gray-50 border border-gray-200 rounded-2xl p-10">
            ...
            <div className="flex items-center justify-center gap-3">
              <div className="w-10 h-10 rounded-full bg-[#7B1C2E]/10 border border-[#7B1C2E]/20 flex items-center justify-center font-bold text-[#7B1C2E] text-sm">F</div>
      ...
      {/* ── TRUST ── */}
      <section className="py-12 bg-[#7B1C2E]">
      ...
      <section className="py-16 bg-white">
        <div className="max-w-2xl mx-auto px-6 text-center">
          ...
          <Link to="/choose-role"
            className="inline-block bg-[#7B1C2E] text-white px-10 py-4 rounded-lg font-bold text-base hover:bg-[#5e1522] transition-colors shadow-sm"
          >
