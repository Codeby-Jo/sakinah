    ...
    <div className="sk-viewport">
      <div className="min-h-screen flex items-start justify-center px-6 py-12">
        <div className="w-full max-w-[560px]">
          <SakinahHeader title="Review Profile" subtitle="Step 6 of 6 · Final Review" onBack={() => navigate('/preferences')} />
          ...
          <div className="flex gap-3 mt-6 sk-fx sk-d3">
            <SakinahButton variant="ghost" onClick={() => navigate('/profile-creation')} className="flex-1">
              Edit Profile
            </SakinahButton>
